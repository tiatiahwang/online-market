  ...
  return (
    <div className='fixed bottom-0 w-full mx-auto max-w-sm grid grid-cols-4 border-t border-dark-bg dark:border-light-bg  px-5 py-3 *:text-light-text *:dark:text-dark-text'>
      <Link href='/products' className='flex flex-col items-center gap-px'>
        {pathname === '/products' ? (
          <HomeFullIcon width='30' height='30' fill='#87ab69' stroke='none' />
        ) : (
      ...
      <Link href='/life' className='flex flex-col items-center gap-px'>
        {pathname === '/life' ? (
          <LifeFullIcon width='30' height='30' fill='#87ab69' stroke='none' />
        ) : (
      ...
      <Link href='/chat' className='flex flex-col items-center gap-px'>
        {pathname === '/chat' ? (
          <ChatFullIcon width='28' height='30' fill='#87ab69' stroke='none' />
        ) : (
      ...
      <Link href='/profile' className='flex flex-col items-center gap-px'>
        {pathname === '/profile' ? (
          <UserFullIcon width='30' height='30' fill='#87ab69' stroke='none' />
        ) : (
