...
const BottomDrawer = ({ productId }: { productId: string }) => {
  ...
  return (
    <>
      ...
      {openDrawer && (
        <div
          className='z-40 fixed inset-0 max-w-sm mx-auto w-full h-screen bg-[#212121]/50'
          onClick={() => setOpenDrawer(false)}
        >
          <div className='w-full max-w-sm mx-auto z-50 fixed bottom-0 bg-dark-bg border-t px-4 py-6 space-y-6 h-[150px]'>
